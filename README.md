...
|-------------------------------|-----------------------------------------------|---------------------------|
| `GLUETUN_IMAGE`               | `qmcgaw/gluetun:latest`                      | Gluetun VPN image         |
| `QBITTORRENT_IMAGE`           | `ghcr.io/hotio/qbittorrent:release-5.1.4`    | qBittorrent image         |
| `QSTICKY_IMAGE`               | `ghcr.io/monstermuffin/qsticky:latest`        | qSticky image             |
| `SLSKD_IMAGE`                 | `slskd/slskd:0.24.3`                         | Soulseek image            |
